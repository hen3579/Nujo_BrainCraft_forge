...
public class SectionViewCuller {
    ...
    /** 手动启用标志：true = 用户手动开启了剖视图，允许自动检测；false = 关闭（默认） */
    private static boolean manualEnable = false;

    /** 强制下次 update 立即执行检测（手动启用切换后需要即时响应） */
